            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative inline-block text-left">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-2 bg-zinc-100 hover:bg-zinc-200 border border-zinc-200 rounded-lg text-xs font-semibold text-zinc-650 hover:text-zinc-950 transition duration-350 shadow-sm focus:outline-none select-none"
              ...
              <button
                ...
                className="rounded-lg border border-zinc-200 bg-zinc-100 px-4 py-2 text-xs font-semibold text-zinc-600 hover:bg-zinc-200 hover:text-zinc-900 transition-all"
              >
                Sign Out
              </button>
            </div>
        ...
        <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-zinc-50/70 backdrop-blur-md border border-zinc-200 rounded-2xl p-6 shadow-sm">
            <div>
              ...
              <p className="text-sm text-zinc-500 mt-1">Here is a quick snapshot of your farm.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Link href="/dashboard/herd" className="flex items-start gap-4 p-4 rounded-xl border border-zinc-200 bg-white/70 hover:bg-zinc-50/70 backdrop-blur-md transition duration-300 group shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-500 mt-1">Manage active/archived pigs, register piglets/breeders, track locations, and view individual pig profiles.</p>
                </div>
              </Link>
              ...
              <Link href="/dashboard/feed" className="flex items-start gap-4 p-4 rounded-xl border border-zinc-200 bg-white/70 hover:bg-zinc-50/70 backdrop-blur-md transition duration-300 group shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-500 mt-1">Calculate projected herd feed demand, formulate stage rations, and log inventory usage/restocks.</p>
                </div>
              </Link>
              ...
              <Link href="/dashboard/activities" className="flex items-start gap-4 p-4 rounded-xl border border-zinc-200 bg-white/70 hover:bg-zinc-50/70 backdrop-blur-md transition duration-300 group shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-500 mt-1">Log mating, pregnancy confirmation, farrowing births, weaning moves, castration, iron injections, and deworming.</p>
                </div>
              </Link>
              ...
              <Link href="/dashboard/financials" className="flex items-start gap-4 p-4 rounded-xl border border-zinc-200 bg-white/70 hover:bg-zinc-50/70 backdrop-blur-md transition duration-300 group shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-500 mt-1">Record and categorize incomes and expenses, monitor profit margins, and track transactions tied to specific pigs.</p>
                </div>
              </Link>
              ...
              <Link href="/dashboard/hr" className="flex items-start gap-4 p-4 rounded-xl border border-zinc-200 bg-white/70 hover:bg-zinc-50/70 backdrop-blur-md transition duration-300 group shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-500 mt-1">Register farm staff members, log payroll details, manage active/leave statuses, and enable application login access.</p>
                </div>
              </Link>
              ...
              <Link href="/dashboard/hub" className="flex items-start gap-4 p-4 rounded-xl border border-zinc-200 bg-white/70 hover:bg-zinc-50/70 backdrop-blur-md transition duration-300 group shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-500 mt-1">Connect with verified vet doctors, feed sellers, and pig buyers, and publish local listing suggestions.</p>
                </div>
              </Link>
              ...
              <Link href="/dashboard/symptoms" className="flex items-start gap-4 p-4 rounded-xl border border-zinc-200 bg-white/70 hover:bg-zinc-50/70 backdrop-blur-md transition duration-300 group shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-500 mt-1">Analyze symptoms (skin, stool, breathing) against a swine disease engine to identify issues and treatments.</p>
                </div>
              </Link>
              ...
              <Link href="/dashboard/weight" className="flex items-start gap-4 p-4 rounded-xl border border-zinc-200 bg-white/70 hover:bg-zinc-50/70 backdrop-blur-md transition duration-300 group shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-500 mt-1">Estimate pig live and carcass weights using length and girth tape measurements. Save direct to profiles.</p>
                </div>
              </Link>
